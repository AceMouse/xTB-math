...
\begin{equation}
    1=C\int_{E^\Gamma_L}^{0}e \,de=C\int_{E^\Gamma_L}^{E^\Gamma_H}e \,de=-C\frac{{E^\Gamma_L}^2-{E^\Gamma_H}^2}{2}
\end{equation}
If we solve for C
\begin{equation}
...
\begin{equation}
    \begin{split}
        -\frac{2}{{E^\Gamma_L}^2-{E^\Gamma_H}^2}\int_{E^\Gamma_L}^{E^\Gamma_L+\delta}e \,de
