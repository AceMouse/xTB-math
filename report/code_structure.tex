...
.3 gfn2.py\DTcomment{xTB-GFN2 specific constants}.
...
.3 data/\DTcomment{test data for electro.cpp computed from caffeine}.
.4 atomicGam.txt.
.4 dqsh.txt.
.4 dq.txt.
.4 H0.txt.
...
.4 shellGam.txt.
.4 shift.txt.
.2 electro.cpp\DTcomment{SYCL impl for computing electrostatic energy}.
}
