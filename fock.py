...
#def getCoordinationNumber(trans, cutoff, cf, cn, dcndr, dcndL):
def getCoordinationNumbers(element_ids, positions):
   ...
   #real(wp), intent(out) :: dcndL(:, :, :)
    ...
    # NOTE: We have only covered the GFN case below
    return ncoordLatP(element_ids, positions)
